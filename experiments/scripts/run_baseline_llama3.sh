#!/bin/bash
# Baseline: vanilla ZeRO-3 training with LLaMA-3
# Usage: bash run_baseline_llama3.sh [model_size] [num_steps] [num_gpus]
...
deepspeed --num_gpus=$NUM_GPUS \
    ...
    --num_steps $NUM_STEPS \
    --deepspeed_config "$CONFIG_DIR/ds_config_baseline_llama3.json"
