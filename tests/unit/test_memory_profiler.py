...
class TestMemoryProfiler:
    ...
    def test_compute_budget_basic(self):
        ...
        # 12 GB total, 6 GB peak, 10% safety, 20% optimizer est -> budget = 3.6 GB
        ...
        expected = 12_000_000_000 - 6_000_000_000 - 1_200_000_000 - 1_200_000_000  # 3.6 GB
    ...
    def test_compute_budget_numel_fp16(self):
        ...
        expected_bytes = 12_000_000_000 - 6_000_000_000 - 1_200_000_000 - 1_200_000_000
    ...
    def test_compute_budget_near_full(self):
        ...
        budget = profiler.compute_budget_bytes()
        # 12 - 11.5 - 1.2 - 2.3 = -3.0 -> clamped to 0
        assert budget == 0
    ...
    def test_zero_safety_margin(self):
        ...
        budget = profiler.compute_budget_bytes()
        # 12 - 4 - 0 (safety) - 0.8 (optimizer est) = 7.2 GB
        assert budget == 7_200_000_000
